window.onload = () => {
    ...
    function checkPrice() {
        ...
        if (assignments > 20000) {
            document.getElementById('location1').style.backgroundColor = "#025993bd";
            document.getElementById('location1').style.color = "antiquewhite";
        }
        else
            document.getElementById('location1').style.backgroundColor = "#3d3b3c";

        if (maxStudents == 5000)
            document.getElementById('location1').style.backgroundColor = 'rgb(9, 145, 9)';

        if (assignments > 500000) {
            document.getElementById('location2').style.backgroundColor = "#025993bd";
            document.getElementById('location2').style.color = "antiquewhite";
        }
        else
            document.getElementById('location2').style.backgroundColor = "#3d3b3c";

        if (maxStudents == 500000)
            document.getElementById('location2').style.backgroundColor = 'rgb(9, 145, 9)';
    ...
    //loc1
    document.getElementById("location1").onclick = (event) => {
        event.preventDefault;
        if (maxStudents < 5000) {
            if (assignments > 20000) {
                assignments -= 20000;
    ...
    //loc2
    document.getElementById("location2").onclick = (event) => {
        event.preventDefault;
        if (maxStudents < 500000) {
            if (assignments > 500000) {
                assignments -= 500000;
